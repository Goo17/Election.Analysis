...
county_with_highest_turnout = ""
county_with_highest_turnout_count = 0
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_options:
        ...
        if (votes > county_with_highest_turnout_count):
            county_with_highest_turnout_count = votes
            county_with_highest_turnout = county_name

    largest_county_turnout_summary = (
        f"\n-------------------------\n"
        f"Largest County Turnout: {county_with_highest_turnout}\n"
        f"-------------------------\n")
